document.addEventListener('DOMContentLoaded', () => {
  ...
  const statusMessages = [
    ...
    'rewriting code i wrote yesterday',
    'pretending to understand p-chem',
    'running gels at midnight',
    'coffee #3 of the day',
    'reading papers i should have read last week',
    'convincing myself sleep is optional',
    'why is my code working',
    'staring at a western blot',
    'forgot to eat lunch again',
    'applying to things',
    'reorganizing my notion for the 4th time',
    'watching surgery videos on youtube',
    'writing a personal statement draft #47',
    'calculating my gpa after every assignment',
    'pretending i understand immunology',
    'looking at apartments in boston',
    'wondering if i need another lab',
    'answering crisis texts',
    'meal prepping at 11pm',
    'making flashcards i will never review',
    'rethinking my entire career path',
    'googling "is 6 labs enough"',
    'listening to the same playlist for 8 hours',
    'telling myself this is the last commit',
    'refreshing my email',
    'updating my spreadsheet',
    'icing my wrists from pipetting',
    'trying to parallel park',
    'convincing myself to go to the gym',
    'watching anki reviews pile up',
    'reading pubmed at 1am',
    'probably overcaffeinated',
    'making a to-do list of my to-do lists',
    'editing a youtube video',
    'pretending to be productive',
    'actually being productive',
    'writing code instead of studying',
    'studying instead of writing code',
    'contemplating a nap',
    'napping',
    'should be sleeping',
    'on hour 14 of being awake',
    'eating cereal for dinner',
    'wondering what normal people do',
    'fixing a bug i introduced fixing a bug',
    'in the primate facility',
    'thinking about protein folding',
    'autodocking something',
    'running rosetta jobs',
    'waiting for slurm',
    'ssh-ing into a cluster',
    'forgot my lab notebook',
    'looking at memes instead of studying',
    'questioning my life choices (affectionately)',
    'pipetting with purpose',
    'reading rejection emails',
    'writing thank-you emails',
    'scheduling a meeting about a meeting',
    'microwaving cold coffee',
    'talking to my rubber duck',
    'git push --force (oops)',
    'pretending my sleep schedule is fine',
    'doing laundry at 2am',
    'watching one more lecture at 2x speed',
    'ctrl+z ctrl+z ctrl+z',
    'reading the error message this time',
    'stack overflow copy paste',
    'wondering if med school is worth it',
    'it is',
    'probably',
    'definitely',
    'recalibrating the microscope',
    'writing an abstract at the deadline',
    'eating monster #224',
    'pretending to network',
    'actually networking',
    'zoning out in lecture',
    'taking notes i cannot read',
    ...
    'this is fine',
    'peak overzealousness',
    'somewhere between burnout and flow state',
    'living in the library',
    'charging my laptop at 3%',
